...
public sealed class DesktopAccessibilityLabelTests
{
    ...
    public void Dialog_xaml_files_should_define_expected_automation_ids()
    {
        ...
        Assert.Contains("AutomationProperties.Name=\"{i18n:Loc UpdateCheck.Title}\"", updateXaml);
        ...
        Assert.Contains("AutomationProperties.HelpText=\"{i18n:Loc UpdateCheck.HelpText}\"", updateXaml);
        ...
        Assert.Contains("AutomationProperties.Name=\"{i18n:Loc VehicleStarterBundle.CloseName}\"", bundleXaml);
        Assert.Contains("AutomationProperties.AutomationId=\"ApplyBundleButton\"", bundleXaml);
        Assert.DoesNotMatch("[ÁČĎÉĚÍŇÓŘŠŤÚŮÝŽáčďéěíňóřšťúůýž]", bundleXaml);
    ...
    public void Editor_fields_should_define_explicit_accessibility_automation_ids()
    {
        ...
        Assert.Contains("AutomationProperties.Name=\"{i18n:Loc TimelineWorkspace.SearchName}\"", timelineXaml);
        Assert.Contains("AutomationProperties.AutomationId=\"ClearTimelineSearchButton\"", timelineXaml);
        Assert.Contains("AutomationProperties.Name=\"{i18n:Loc TimelineWorkspace.ClearSearchName}\"", timelineXaml);
        Assert.Contains("AutomationProperties.AutomationId=\"TimelineOpenButton\"", timelineXaml);
        Assert.Contains("AutomationProperties.Name=\"{i18n:Loc TimelineWorkspace.OpenItemName}\"", timelineXaml);
        Assert.Contains("AutomationProperties.ItemType=\"{i18n:Loc TimelineWorkspace.ItemType}\"", timelineXaml);
        Assert.Contains("AutomationProperties.AutomationId=\"GlobalSearchTextBox\"", globalSearchXaml);
        Assert.Contains("AutomationProperties.Name=\"{i18n:Loc GlobalSearchWorkspace.SearchName}\"", globalSearchXaml);
        Assert.Contains("AutomationProperties.AutomationId=\"ClearGlobalSearchButton\"", globalSearchXaml);
        Assert.Contains("AutomationProperties.Name=\"{i18n:Loc GlobalSearchWorkspace.ClearSearchName}\"", globalSearchXaml);
        Assert.Contains("AutomationProperties.AutomationId=\"GlobalSearchSortComboBox\"", globalSearchXaml);
        Assert.Contains("AutomationProperties.Name=\"{i18n:Loc GlobalSearchWorkspace.SortName}\"", globalSearchXaml);
        ...
        Assert.Contains("AutomationProperties.Name=\"{i18n:Loc GlobalSearchWorkspace.OpenItemName}\"", globalSearchXaml);
        Assert.Contains("AutomationProperties.ItemType=\"{i18n:Loc GlobalSearchWorkspace.ItemType}\"", globalSearchXaml);
