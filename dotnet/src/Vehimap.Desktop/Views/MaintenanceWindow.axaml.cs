...
public partial class MaintenanceWindow : Window
{
    ...
    private void OnOpened(object? sender, EventArgs e)
    {
        ...
        {
            if (_viewModel?.IsEditingMaintenance == true)
            {
    ...
    {
        if (target is DesktopFocusTarget.MaintenanceList or DesktopFocusTarget.MaintenanceEditorTitle)
        {
            RequestFocus(target);
        }
    }
    ...
    private Control? ResolveFocusTarget(DesktopFocusTarget target)
    {
        ...
        {
            DesktopFocusTarget.MaintenanceList => this.FindControl<ListBox>("MaintenanceWindowListBox"),
            DesktopFocusTarget.MaintenanceEditorTitle => this.FindControl<TextBox>("MaintenanceWindowTitleBox"),
            _ => null
        };
    }
