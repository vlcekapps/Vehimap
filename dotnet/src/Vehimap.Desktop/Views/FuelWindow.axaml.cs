...
public partial class FuelWindow : Window
{
    ...
    private void OnOpened(object? sender, EventArgs e)
    {
        ...
        {
            if (_viewModel?.IsEditingFuel == true)
            {
    ...
    {
        if (target is DesktopFocusTarget.FuelList or DesktopFocusTarget.FuelEditorDate)
        {
            RequestFocus(target);
        }
    }
    ...
    private Control? ResolveFocusTarget(DesktopFocusTarget target)
    {
        ...
        {
            DesktopFocusTarget.FuelList => this.FindControl<ListBox>("FuelWindowListBox"),
            DesktopFocusTarget.FuelEditorDate => this.FindControl<TextBox>("FuelWindowDateBox"),
            _ => null
        };
    }
