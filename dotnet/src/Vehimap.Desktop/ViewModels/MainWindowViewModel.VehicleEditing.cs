    ...
    private string BuildVehicleDeleteConfirmationMessage(string vehicleId, string vehicleName)
    {
        ...
        return string.Join(
            ...
            [
                ...
                FormatPlural("VehicleDelete.Confirmation.HistoryCount", historyCount, historyCount),
                FormatPlural("VehicleDelete.Confirmation.FuelCount", fuelCount, fuelCount),
                FormatPlural("VehicleDelete.Confirmation.RecordCount", recordCount, recordCount),
                FormatPlural("VehicleDelete.Confirmation.ReminderCount", reminderCount, reminderCount),
                FormatPlural("VehicleDelete.Confirmation.MaintenanceCount", maintenanceCount, maintenanceCount),
                string.Empty,
