...
| 1.3.1 Info and Relationships | A | Partially Supports | Standard Avalonia controls, headings, shell context text, standalone workspace summaries, item types/statuses, landmarks and accessible names are guarded. | Continue static UIA guard tests and manual NVDA verification of dense dialogs. |
...
| 3.3.2 Labels or Instructions | A | Supports | Editor fields, visible dialog/form guidance and data-changing actions have labels, accessible names and consequence-oriented help text. | Keep static accessibility label tests green. |
...
| 4.1.2 Name, Role, Value | A | Partially Supports | UI Automation names, shell context text, standalone workspace summaries, visible dialog/form guidance, item types/statuses, headings and live regions are guarded. | TextBox UIA fallback remains known exception. |
