...
| 3.3.2 Labels or Instructions | A | Supports | Editor fields and data-changing actions have labels, accessible names and consequence-oriented help text. | Keep static accessibility label tests green. |
...
| 4.1.2 Name, Role, Value | A | Partially Supports | UI Automation names, shell context text, item types/statuses, headings and live regions are guarded. | TextBox UIA fallback remains known exception. |
