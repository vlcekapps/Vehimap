...
| 3.3.4 Error Prevention | AA | Partially Supports | Backup/restore/update/destructive flows use confirmations and status text. | Review all data-replacing actions before ACR publication. |
