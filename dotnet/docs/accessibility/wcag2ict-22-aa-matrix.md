...
| 4.1.2 Name, Role, Value | A | Partially Supports | UI Automation names, shell context text, standalone workspace summaries, visible form guidance, item types/statuses, headings and live regions are guarded. | TextBox UIA fallback remains known exception. |
