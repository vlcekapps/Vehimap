...
| Forced colors / high contrast | 1.4.3, 1.4.11, 2.4.7 | The custom workspace tab strip now has a guarded standard-theme focus border/background, but visual contrast evidence is not complete for every state and platform theme. | Capture manual Windows forced-colors pass and fix any hidden focus/status regressions. |
