...
- Windows hardening wrapper `dotnet/build/Test-DotnetWindowsHardening.ps1`, ktery pred beta kanalem spoji release train status, cele `dotnet test`, nightly readiness s instalacnim smoke testem, volitelnou kontrolu publikovane nightly a informativni AHK retirement status
