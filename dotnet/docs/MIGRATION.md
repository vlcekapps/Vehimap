...
- installer smoke `dotnet/build/Test-DotnetInstallerSmoke.ps1`, ktery ve vychozim rezimu overi Windows setup EXE, `.sha256` a JSON metadata a s explicitnim `-Install` provede izolovanou tichou instalaci, portable launch smoke a odinstalaci
