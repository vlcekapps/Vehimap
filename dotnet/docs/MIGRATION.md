...
- editor vozidla je prvni presunuty dialogovy editor: pridani/uprava vozidla se uz nemicha s ctecim detailem, modalni dialog ma vlastni prvni fokus, `Esc`/`Zrusit`, live status a navrat fokusu podle toho, zda byl otevren z menu, detailu, dashboardu, nakladu nebo auditu
