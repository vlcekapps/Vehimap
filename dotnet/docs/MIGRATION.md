...
- release promotion gate `dotnet/build/Test-DotnetReleasePromotion.ps1`, ktery hlida proces `nightly -> beta -> stable`, pred stable vyzaduje existujici beta tag pro stejnou verzi a pri uspesne kontrole vypise doporuceny kanalovy readiness wrapper i tagovaci prikaz
