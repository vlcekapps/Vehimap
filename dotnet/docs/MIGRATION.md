...
2. Radu 2.0 zatim drzet jako dlouhou nightly etapu, ne jako beta kandidata. Dalsi bezny vyvoj delat pres `nightly` na `main`; Windows rucne testovat pres `dotnet/artifacts/nightly/win-x64/app/Vehimap.Desktop.exe` a celou desktop matici vytvaret pres `Test-DotnetNightlyMatrix.ps1` do `dotnet/artifacts/nightly/<rid>/`.
