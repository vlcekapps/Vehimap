...
- vyber polozky, detailni text a editorovy stav evidenci `Historie`, `Tankovani`, `Pripominky` a `Udrzba` jsou vlastnene jejich workspace viewmodely; root je pouziva jen interne pri persistu a navigaci
