...
8. Po stabilizaci Windows 2.0 storage a i18n zakladu zacit Android vetvi jako dalsi platformu; nejdrive jen sdilena domena, SQLite storage a read-only shell nad testovacimi daty.
