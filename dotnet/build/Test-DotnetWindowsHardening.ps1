...
Write-Host "Dalsi krok v dlouhe 2.0 nightly etape:"
Write-Host "  powershell -NoLogo -NoProfile -ExecutionPolicy Bypass -File .\build\Test-DotnetStorageNightlyGate.ps1 -RuntimeIdentifier $RuntimeIdentifier"
