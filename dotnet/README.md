...
- na Windows runneru spustit Appium smoke nad publish buildem desktop release vcetne kontroly app-level menu a dostupnosti rychlych akci; CI instaluje WinAppDriver z pevneho MSI assetu se SHA-256 kontrolou misto anonymniho Appium `install-wad` GitHub API dotazu, aby nightly nepadaly na rate limitu hostovaneho runneru
