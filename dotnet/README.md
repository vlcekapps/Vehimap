...
- zname legacy hodnoty vyberovych poli se neprepisuji v databazi, ale zobrazuji se lokalizovane pres `.resx`; pokryte jsou kategorie vozidel, stav/pohon/profil vozidla, typ paliva, typ dokladu a opakovani pripominek v seznamu/detailu vozidla, editorech, balicku pro vozidlo, tankovani, dokladech, pripominkach, casove ose, globalnim hledani a exportech nakladu
- kompatibilni aliasy patri na hranice legacy/resource vrstev: opakovani pripominek pouziva pojmenovane legacy konstanty a rezimy priloh dokladu se rozpoznavaji pres EN/CS resource hodnoty, ne pres nove hardcoded UI texty v desktop logice
- ulozene volby filtru, razeni, nakladovych obdobi a navigacnich cilu nepouzivaji viditelny EN/CS text jako ridici hodnotu; nove preference ukladaji stabilni klice jako `all`, `future`, `green_cards`, `cost`, `vehicle` nebo `custom` a stare ceske/anglicke labely slouzi jen jako kompatibilni aliasy
...
- platformni diagnostika pro otevreni souboru/slozky a vytvoreni autostartu uz take pouziva live EN/CS localizer; servisni knizka pri vyberu relevantnich dokladu rozpoznava ceska i anglicka servisni klicova slova
