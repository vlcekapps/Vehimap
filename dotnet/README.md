...
- globalni napoveda rozbalovacich seznamu, pending-edit lock/confirmation hlasky a GitHub feedback issue sablona uz take pouzivaji EN/CS `.resx`
- app-level okraje jako installer locale seed statusy, potvrzeni obnovy zalohy, kratke native tray menu a close-action texty samostatnych evidencnich oken uz take pouzivaji EN/CS `.resx`
