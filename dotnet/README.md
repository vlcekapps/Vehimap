...
- pocetni vety pouzivaji `IAppPluralizationService`: resource rodina ma varianty `.One`, `.Few` a `.Other`, anglictina vybira jednotne/mnozne cislo a cestina spravny tvar pro `1`, `2-4` a ostatni pocty; brana pokryva hlavni evidence, audit, poradce, terminove prehledy, analyzu tankovani, naklady, detail vozidla, startovaci balicek a titulky oznameni a primy `LF/Format` nad migrovanou univerzalni sablonou blokuje test
