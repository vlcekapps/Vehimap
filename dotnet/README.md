...
- radit evidencni seznamy `Historie`, `Tankovani`, `Pripominky` a `Doklady` pres pristupne ovladace `Radit` a `Sestupne`; posledni sloupec i smer razeni se ukladaji do legacy `settings.ini`
