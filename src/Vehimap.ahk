...
global VehiclePowertrainOptions := ["", "Benzín", "Nafta", "Hybrid", "Plug-in hybrid", "Elektro", "LPG / CNG", "Jiné"]
global VehicleClimateProfileOptions := ["", "Má klimatizaci", "Bez klimatizace"]
global VehicleTimingDriveOptions := ["", "Řemen", "Řetěz", "Není relevantní"]
global VehicleTransmissionOptions := ["", "Manuální", "Automatická", "Není relevantní"]
...
global RecordFormInitialAttachmentMode := ""
global RecordFormInitialFilePath := ""
