...
- výběr položky, detailní text a editorový stav evidencí `Historie` a `Tankování` v Avalonia větvi už nejsou veřejné root proxy vlastnosti; patří přímo jejich workspace viewmodelům
