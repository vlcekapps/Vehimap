...
- Lokalizační pilot nově pokrývá další app-level okraje: hlášky jednorázového jazykového seedu z instalátoru, potvrzení obnovy zálohy, krátké nativní tray menu a popisy zavření rozpracovaných evidenčních editorů v samostatných oknech.
...
- Lokalizační pilot nově pokrývá také dialog `Zkontrolovat aktualizace` a průběhové okno stahování aktualizace, včetně titulků, tlačítek, detailů pro schránku, progress statusů a EN/CS textů dynamického update viewmodelu.
