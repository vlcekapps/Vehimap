...
- přístupné okno `Akce Vehimapu na liště` v Avalonia větvi umí kromě hlavního okna, dashboardu a ukončení aplikace otevřít i `Blížící se termíny` a `Propadlé termíny`
