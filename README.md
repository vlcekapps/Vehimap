...
- v C# desktopové větvi vlastní `HistoryWorkspace`, `FuelWorkspace`, `ReminderWorkspace` a `MaintenanceWorkspace` i výběr položky, detailní texty a stav svých editorů; root už je nevystavuje jako veřejné aliasy
