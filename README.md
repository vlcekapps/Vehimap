...
- `Rychlé akce` v C# Avalonia větvi: nejbližší TK, kontrola TK, nejbližší zelená karta, kontrola zelených karet, nejbližší vlastní připomínka a kontrola připomínek
